...
export function MobileNav() {
  ...
  return (
    <nav
      className="site-chrome fixed inset-x-4 bottom-4 z-50 flex items-center gap-1 overflow-x-auto rounded-full border border-border/80 bg-card/90 p-1 shadow-soft sm:hidden"
